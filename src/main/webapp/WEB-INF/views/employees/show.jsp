		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td><fmt:formatDate value="${createDay}" pattern="yyy-MM-dd HH:mm:ss"/>
				</tr>
				<tr>
					<th>更新日時</th>
					<fmt:parseDate value="${employee.updatedAt}" pattern="yyy-MM-dd'T'HH:mm:ss" var="updateDay" type="date"/>
