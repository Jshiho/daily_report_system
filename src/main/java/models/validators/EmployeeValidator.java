...
public class EmployeeValidator {
	 ...
	 * @param codeDuplicateChevkFlag 社員番号の重複チェックを実施するかどうか
	 * （実施する：true 実施しない：false)
	 * @param passwordCheckFlag　パスワードの入力チェックを実施するかどうか
	 * @return エラーのリスト
	 */
	 ...
	 * @param code 社員番号
	 * @param codeDuplicateCheckFlag 社員番号の重複チェックを実施するか
	 * （実施する：true 実施しない:false)
	 * @return エラーメッセージ
	 */
	...
	private static String validateCode(EmployeeService service, String code, Boolean codeDuplicateCheckFlag) {
		...
		if (codeDuplicateCheckFlag) {
			...
			//同一社員番号が既に登録されている場合にはエラーメッセージを返却
			if (employeeConst > 0) {
	...
	/**
	 * @param sevice EmployeeServiceのインスタンス
	 * @param code 社員番号
	...
	/**
	 * パスワードの入力チェックを行いエラーメッセージを返却
	 * @param password パスワード
	 * @param passwordChekFlag パスワードの入力チェックを実施するかどうか
	 * （実施する：true 実施しない：false)
	 * @return エラーメッセージ
	 */
